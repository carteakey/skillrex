...
Built for [AI agent](https://github.com/NousResearch/agent-skills). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/agent-skills/skills/creative/ascii-video`](https://github.com/NousResearch/agent-skills/tree/main/skills/creative/ascii-video) via PR.
