...
## Additional references (absorbed from agent-created llm-fine-tuning skill)

- **[grpo-rl-training-deep-dive.md](references/grpo-rl-training-deep-dive.md)** — Extended GRPO/RL training reference: reward function design patterns, FSDP distributed training configs, production training workflows, and reward hacking mitigation
