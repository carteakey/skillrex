...
- `references/guidance-structured-output.md` - Microsoft Guidance library for structured generation: regex/grammar constraints, token healing, Jinja-based prompt programs, and comparison with Outlines (absorbed from agent-created inference-optimization skill)
